...
void freeAstreeMemory(ASTREE *raiz) {
	...
	if(raiz->son[0]) freeAstreeMemory(raiz->son[0]);
	if(raiz->son[1]) freeAstreeMemory(raiz->son[1]);
	if(raiz->son[2]) freeAstreeMemory(raiz->son[2]);
	if(raiz->son[3]) freeAstreeMemory(raiz->son[3]);
	free(raiz);
}